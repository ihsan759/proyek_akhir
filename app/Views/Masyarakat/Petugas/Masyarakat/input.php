...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Upload Scan KK</h6>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?= base_url('masyarakat') ?>/KK" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control-file <?= ($validation->hasError('file_kk')) ? 'is-invalid' : '' ?>" id="KK" name="file_kk" value="<?= old('file_kk') ?>" accept=".pdf,.jpg,.jpeg,.png">
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Upload Scan KTP</h6>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?= base_url('masyarakat') ?>/KTP" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control-file <?= ($validation->hasError('file_ktp')) ? 'is-invalid' : '' ?>" id="exampleFormControlFile1" name="file_ktp" value="<?= old('file_ktp') ?>" accept=".pdf,.jpg,.jpeg,.png">
                            <small id="exampleFormControlFile1" class="form-text text-muted">Silahkan Upload scan KTP dalam bentuk pdf, jpg, jpeg, png.</small>
                            <div class="invalid-feedback">
