...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data" action="<?= base_url('berita/update/' . $berita['id']) ?>">
                <?= csrf_field() ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : '' ?>" id="exampleInputEmail1" aria-describedby="emailHelp" name="judul" value="<?= (old('judul')) ? old('judul') : $berita['judul'] ?>" autofocus>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= ($validation->hasError('caption')) ? 'is-invalid' : '' ?>" id="exampleInputEmail1" aria-describedby="emailHelp" name="caption" value="<?= (old('caption')) ? old('caption') : $berita['caption'] ?>">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control <?= ($validation->hasError('isi')) ? 'is-invalid' : '' ?>" id="ckeditor" name="isi"><?= (old('isi')) ? old('isi') : $berita['isi'] ?></textarea>
                    <script>
